...
# Define default bold font for consistency
...
# Override CTkLabelFrame if not defined, ensuring its title label uses a bold font.
if not hasattr(ctk, "CTkLabelFrame"):
    class CTkLabelFrame(ctk.CTkFrame):
        def __init__(self, master, text="", font=None, **kwargs):
            # If no custom font is provided, use the default bold font.
...
# ----------------- Main Window Setup ----------------- #
root = ctk.CTk()
root.title("Welcome to Sales and Service Management - Employee")
...
# Inner frame for service widgets
